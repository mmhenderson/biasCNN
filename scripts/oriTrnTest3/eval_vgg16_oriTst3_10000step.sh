...
load_log_dir=${root}logs/vgg16_oriTrn3_long
...
save_eval_dir=${root}activations/vgg16_oriTst3_long_full
if [ ! -d ${save_eval_dir} ]
then
...
reduced_dir=${root}activations/vgg16_oriTst3_long_reduced
if [ ! -d ${reduced_dir} ]
then
	mkdir -p ${reduced_dir}
fi
