...
load_log_dir=${root}logs/inception_oriTrn1_long
...
save_eval_dir=${root}activations/inception_oriTst1_long_full
if [ ! -d ${save_eval_dir} ]
then
...
reduced_dir=${root}activations/inception_oriTst1_long_reduced
if [ ! -d ${reduced_dir} ]
then
	mkdir -p ${reduced_dir}
fi
