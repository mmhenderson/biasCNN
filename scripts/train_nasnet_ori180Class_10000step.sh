...
# 1. Loads a pre-trained inception-v3 model from checkpoint
# 2. Fine-tunes the logit layers of this network to perform orientation classification (labels 1:180)
#
# Usage:
# cd /usr/local/serenceslab/maggie/biasCNN/
# ./train_inceptionV3_ori180Class.sh
...
save_log_dir=${root}logs/nasnet_retrained_grating_orient_sf_long
