...
for ff = 1:nSF
    ...
    image_set = sprintf('%s_SF_%.2f',image_set_root, freq_levels_cpp(ff));
    ...
    for oo = 1:nOrient
        ...
        ims=zeros(image_size,image_size,nImsAtATime);
