...
nSetsToMake = 4;
randseeds = [867757,232438,567767,234344];
sets2make_now = [1:4];
...
image_set_root = 'FiltIms2AllSFSquare';
...
%             image_filt_masked = image_filtered.*mask_image;
            ...
            for cc=1:3
                ...
                % adjust background so background vals are
                % exactly equal over all images.
%                 image_bg_adj = image_z_scaled + (channel_means(cc)-image_z_scaled(1,1))*(1-mask_image);
