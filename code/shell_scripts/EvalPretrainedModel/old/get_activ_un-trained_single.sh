...
save_eval_dir=${ROOT}biasCNN/activations/${model_short}/untrained/params1/${dataset_name}/eval_at_ckpt-0_full
...
reduced_dir=${ROOT}biasCNN/activations/${model_short}/untrained/params1/${dataset_name}/eval_at_ckpt-0_reduced
