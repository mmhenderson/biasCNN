...
ckpt_file=${ROOT}biasCNN/logs/vgg16/ImageNet/scratch_imagenet_45_stop_early/params1/model.ckpt-1
...
do
	...
	${ROOT}biasCNN/code/shell_scripts/EvalPretrainedModel/get_activ_un-trained_train45_single.sh ${which_model} ${dataset_name} ${ROOT} ${ckpt_file} ${overwrite} ${TEST}
