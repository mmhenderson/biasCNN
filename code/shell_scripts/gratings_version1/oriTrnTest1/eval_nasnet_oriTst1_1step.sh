...
load_log_dir=${root}logs/nasnet_oriTrn1_short
...
save_eval_dir=${root}activations/nasnet_oriTst1_short_full
if [ ! -d ${save_eval_dir} ]
then
...
reduced_dir=${root}activations/nasnet_oriTst1_short_reduced
if [ ! -d ${reduced_dir} ]
then
	mkdir -p ${reduced_dir}
fi
