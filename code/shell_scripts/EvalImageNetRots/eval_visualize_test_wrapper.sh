...
do
	...
	${ROOT}biasCNN/code/shell_scripts/EvalImageNetRots/eval_visualize_test.sh ${rot} ${step_num} ${which_hyperpars} ${log_dir} ${dataset_name} ${ROOT}
