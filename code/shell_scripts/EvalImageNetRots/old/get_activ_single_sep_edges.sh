...
reduced_dir=${ROOT}biasCNN/activations/${model_short}/scratch_imagenet_rot_${rot}/${which_hyperpars}/${dataset_name}/eval_at_ckpt-${step_num}_reduced_sep_edges
...
then
	...
	if [[ $TEST != 1 ]]
	then
		python reduce_activations_sep_edges.py \
