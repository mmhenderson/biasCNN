...
networks_map = {'vgg_a': vgg.vgg_a,
                'vgg_16': vgg.vgg_16,
                'vgg_16_avgpool': vgg.vgg_16_avgpool,
                'vgg_19': vgg.vgg_19}

arg_scopes_map = {'vgg_a': vgg.vgg_arg_scope,
                  'vgg_16': vgg.vgg_arg_scope,
                  'vgg_16_avgpool': vgg.vgg_arg_scope,
                  'vgg_19': vgg.vgg_arg_scope}


def get_network_fn(name, num_classes, weight_decay=0.0, weights_initializer=None, biases_initializer=None, is_training=False):
