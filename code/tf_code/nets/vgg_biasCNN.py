...
def vgg_arg_scope(weight_decay=0.0005, weights_initializer=None, biases_initializer=None):
  ...
  print('\nusing %s as weight_initializer\nusing %s as biases initializer\n'%(weights_initializer,biases_initializer))
  ...
  with tf.variable_scope(scope, 'vgg_16', [inputs]) as sc:
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.avg_pool2d],
      ...
      if num_classes:
        ...
        end_points[sc.name + '/fc8'] = net
      return net, end_points
vgg_16_avgpool.default_image_size = 224
