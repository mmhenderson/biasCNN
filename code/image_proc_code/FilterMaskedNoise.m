...
%% load the image
im_file = fullfile(root,'code','image_proc_code','Smoothed_masked_noise.png');
...
% image = image + mean([R_MEAN,G_MEAN,B_MEAN]);
...
suptitle('Masked noise image w filters applied');
