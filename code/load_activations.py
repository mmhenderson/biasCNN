...
def load_activ(model_str):
    ...
    elif model_str == 'vgg16_oriTst2':
        allw, all_labs, info = load_activ_vgg16_oriTst2()
    elif model_str == 'vgg16_oriTst2a':
        allw, all_labs, info = load_activ_vgg16_oriTst2a()
    elif model_str == 'vgg16_oriTst3':
        allw, all_labs, info = load_activ_vgg16_oriTst3()
    elif model_str == 'vgg16_oriTst4':
        allw, all_labs, info = load_activ_vgg16_oriTst4()
    elif model_str == 'vgg16_oriTst4a':
        allw, all_labs, info = load_activ_vgg16_oriTst4a()
    elif model_str == 'vgg16_oriTst5':
        allw, all_labs, info = load_activ_vgg16_oriTst5()
    elif model_str == 'vgg16_oriTst5a':
        allw, all_labs, info = load_activ_vgg16_oriTst5a()
    else:
...
#%%
def load_activ_vgg16_oriTst2():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst2_short_reduced')
    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst2_long_reduced')
...
#%%
def load_activ_vgg16_oriTst2a():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst2a_short_reduced')
#    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst2_long_reduced')
...
#%%
def load_activ_vgg16_oriTst3():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst3_short_reduced')
#    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst3_long_reduced')
...
#%%
def load_activ_vgg16_oriTst4():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst4_short_reduced')
#    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst3_long_reduced')
...
#%%
def load_activ_vgg16_oriTst5():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst5_short_reduced')
#    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst3_long_reduced')
...
#%%
def load_activ_vgg16_oriTst4a():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst4a_short_reduced')
#    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst3_long_reduced')
...
#%%
def load_activ_vgg16_oriTst5a():
    """ load in all my data for this version of the experiment """
    
    info = dict()
    
    weight_path_before = os.path.join(root, 'activations', 'vgg16_oriTst5a_short_reduced')
#    weight_path_after = os.path.join(root, 'activations', 'vgg16_oriTst3_long_reduced')
