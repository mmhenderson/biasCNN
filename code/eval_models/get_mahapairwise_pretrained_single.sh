...
save_dir=${ROOT}/code/mdistpool2/${model_short}/pretrained/params1/${dataset_name}/eval_at_ckpt-0_reduced_varyncomps
...
then
	...
	if [[ $TEST != 1 ]]
	then		
		python get_mdistpool2_allpairwise.py ${reduced_dir} ${save_dir} ${model_short} ${dataset_name}
