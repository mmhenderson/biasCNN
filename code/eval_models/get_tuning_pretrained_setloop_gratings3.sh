...
step_num=0
sf2do=3
python analyze_orient_tuning_jitter_selectSF.py ${ROOT} ${model_short} ${training_str} ${dataset_root} ${nSamples} ${which_hyperpars} ${step_num} ${rand_seed_jitter} ${sf2do}
