...
fisher_dir=${ROOT}/code/fisher_info/${model_short}/scratch_imagenet_rot_${rot}/${which_hyperpars}/${dataset_name}/eval_at_ckpt-${step_num}_reduced_varyncomps
...
then
	...
	then
		num_batches=96		
		python get_fisher_info_vary_ncomps.py ${reduced_dir} ${fisher_dir} ${model_short} ${dataset_name} ${num_batches}
