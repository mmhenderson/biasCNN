...
do
	...
	${CWD}/get_fisher_reduced_varyncomps_single.sh ${rot} ${step_num} ${which_hyperpars} ${which_model} ${dataset_name} ${ROOT} ${log_dir} ${overwrite} ${TEST}
