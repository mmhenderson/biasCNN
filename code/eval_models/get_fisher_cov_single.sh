...
save_dir=${ROOT}/code/fisher_info_cov/${model_short}/scratch_imagenet_rot_${rot}/${which_hyperpars}/${dataset_name}/eval_at_ckpt-${step_num}_reduced_varyncomps
...
then
	...
	if [[ $TEST != 1 ]]
	then		
		python get_fisher_info_cov_vary_ncomps.py ${reduced_dir} ${save_dir} ${model_short} ${dataset_name}
