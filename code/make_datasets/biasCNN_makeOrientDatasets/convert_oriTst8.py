...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst8/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/grating_ims_8/'
  
dataset_name = 'oriTst8'
