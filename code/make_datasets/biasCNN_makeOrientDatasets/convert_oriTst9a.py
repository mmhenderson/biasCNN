...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst9a/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_9a/'
  
dataset_name = 'oriTst9a'
...
nNoiseLevels = 1
noise_levels = [0]
contrast_levels  = np.logspace(np.log10(0.01), np.log10(1), 24)
nContrastLevels = 24
nEx = 1
