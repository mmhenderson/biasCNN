...
dataset_dir = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTrn9b/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_9b/'
  
dataset_name = 'oriTrn9b'
...
def _get_filenames_and_classes(image_dir):
  ...
  for ii in np.arange(0,np.size(model_labels)):
    ...
    filename = "Gaussian_contrast_%.2f_phase_%d_ex1_%ddeg.png" % (contrastlist[ii], phase_vals[phaselist[ii,0]], orilist[ii])
