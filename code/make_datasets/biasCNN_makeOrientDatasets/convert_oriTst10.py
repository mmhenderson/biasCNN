...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst10/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_10/'
  
dataset_name = 'oriTst10'
