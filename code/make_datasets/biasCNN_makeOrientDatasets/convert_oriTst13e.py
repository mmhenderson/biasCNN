...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst13e/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_13e/'
  
dataset_name = 'oriTst13e'
