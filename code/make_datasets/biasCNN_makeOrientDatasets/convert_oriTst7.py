...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst7/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/grating_ims_7/'
  
dataset_name = 'oriTst7'
