...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst13b/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_13b/'
  
dataset_name = 'oriTst13b'
