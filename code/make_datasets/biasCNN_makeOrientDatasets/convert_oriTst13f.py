...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst13f/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_13f/'
  
dataset_name = 'oriTst13f'
