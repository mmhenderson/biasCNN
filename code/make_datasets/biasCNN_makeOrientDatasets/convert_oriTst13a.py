...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst13a/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_13a/'
  
dataset_name = 'oriTst13a'
