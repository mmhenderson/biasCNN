...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst12a/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_12a/'
  
dataset_name = 'oriTst12a'
