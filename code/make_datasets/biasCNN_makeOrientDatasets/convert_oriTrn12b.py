...
dataset_dir = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTrn12b/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_12b/'
  
dataset_name = 'oriTrn12b'
...
def _get_filenames_and_classes(image_dir):
  ...
  for ii in np.arange(0,np.size(model_labels)):
    ...
    filename = "Gaussian_noise_%.2f_phase%d_ex%d_%ddeg.png" % (noiselist[ii,0], phase_vals[phaselist[ii,0]], exlist[ii]+1, orilist[ii])
