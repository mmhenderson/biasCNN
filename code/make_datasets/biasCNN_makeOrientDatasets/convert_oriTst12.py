...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst12/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_12/'
  
dataset_name = 'oriTst12'
