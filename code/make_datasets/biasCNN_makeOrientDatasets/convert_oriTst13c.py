...
dataset_dir_root = '/usr/local/serenceslab/maggie/biasCNN/datasets/oriTst13c/'
image_dir = '/usr/local/serenceslab/maggie/biasCNN/images/grating_ims_13c/'
  
dataset_name = 'oriTst13c'
