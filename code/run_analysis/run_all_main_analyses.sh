...
# Works with networks that I trained w modified images, not pretrained.
...
# whatever set the net was trained on - like "0_cos, 22_cos, 45_cos"
rot=45_cos
...
do
	...
	${CWD}/get_tuning_and_fisher_single.sh ${rot} ${step_num} ${which_hyperpars} ${which_model} ${dataset_name} ${ROOT} ${log_dir} ${overwrite} ${TEST}
